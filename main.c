...
biquad(eq_bq_17)
biquad(eq_bq_18)
// now can run twice as many filters..
...
#define EQ_I_2 0.9251272329048078,-1.6437412015362334,0.8613963562588176,-1.6437412015362334,0.7865235891636254
#define EQ_I_3 0.8653484749619348,-1.1357036283897362,0.7677173901673144,-1.1357036283897362,0.6330658651292491
#define EQ_I_4 1.1812948442183273,-0.8743033533267026,0.6510163824497504,-0.8743033533267026,0.8323112266680777
#elif (USE_EQ == -1) // index source (v3.1), -1dB/oct
// Maximum Volume
// #define POWER_LIMIT 3 // 2^3 > 8x > -18dB
#define POWER_LIMIT 0 // Use LIMIT_MUL as limiter
...
#define EQ_I_0 0.5044176749596154,-0.986643378943754,0.4827034776567025,-1.9688501073857256,0.9693278810582893
#define EQ_I_1 1.057016619246638,-1.8917396238613828,0.84057263900955,-1.8917396238613828,0.897589258256188
#define EQ_I_2 0.9175415913621554,-1.6334104743739235,0.857753899514811,-1.6334104743739235,0.7752954908769664
#define EQ_I_3 0.8472910747484507,-1.117218264200975,0.7591940729237711,-1.117218264200975,0.6064851476722217
#define EQ_I_4 1.1606967395098906,-0.8699812064415425,0.6625563973877961,-0.8699812064415425,0.8232531368976868
...
#define EQ_I_2 1.060795077073329,-1.1007763336734049,0.8170359707640847,-1.1007763336734049,0.8778310478374137
#define EQ_I_3 0.8859564507147561,-0.8480930489292593,0.6765670183005781,-0.8480930489292593,0.5625234690153342
#define EQ_I_4 0.6779969232884223,0.4390839584219345,0.4252605363347426,0.4390839584219345,0.103257459623165
#elif (USE_EQ == 1) // index v1.3
// Maximum Volume
// #define POWER_LIMIT 3 // 2^3 > 8x > -18dB
#define POWER_LIMIT 0 // Use LIMIT_MUL as limiter
...
#elif (USE_EQ == 4) // s05 v5
// Maximum Volume
#define POWER_LIMIT 0 // Use LIMIT_MUL as limiter
#define LIMIT_MUL ((dspfx)(0.316*(double)(1<<27))) // 0.32x > -10dB limit on output, -10-20 > -30dB limit on input
#define BASS_MUL floatfx(1./10.0) // Bass peak filter is 20dB > 10.0x

#define EQ_BASS 1.0149551288553773,-1.997038766193103,0.9821182842924134,-1.997038766193103,0.9970734131477906 // PK Fc 45 Hz Gain 21 dB Q 0.6
#define EQ_BASS_2 0.991591026159956,-1.9633199405676882,0.9720826180595981,-1.9633199405676882,0.963673644219554 // PK Fc 145 Hz Gain -5.4 dB Q 0.7

#define EQ_I_0 0.9771762479447592,-1.8199875065725295,0.8707455015921033,-1.8199875065725295,0.8479217495368625
#define EQ_I_1 0.8632677857010335,-1.5296489035160727,0.7487728644024134,-1.5296489035160727,0.6120406501034469
#define EQ_I_2 1.088738731680456,-1.2129031765808629,0.7329389700755262,-1.2129031765808629,0.8216777017559822
#define EQ_I_3 0.8377940873767151,-0.0104619598155081,0.3731828816710627,-0.0104619598155081,0.2109769690477778
#define EQ_I_4 0.6185823689313048,0.7623221471718112,0.4603516759970083,0.7623221471718112,0.0789340449283131
#endif
...
#define DEFAULT_VOLUME       ENCODE_DB(-6) // -6dB (In Windows, -6dB -> 70% and -10dB -> 50%, i think)
#define MAX_VOLUME           0
...
static void audio_set_volume(int16_t volume) {
    ...
    if (pos > 101) {
        ...
        audio_state.vol_mul = (db_to_vol_hp[100] * (256 - mix)) >> 8;
    }
    else {
